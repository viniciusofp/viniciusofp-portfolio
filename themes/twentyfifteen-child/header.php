...
<div class="scene_element scene_element--fadeOut"> <!-- transition container -->
...
<nav role="navigation" class="navbar navbar-default navbar-fixed-top scene_element scene_element--fadeindown">
    <div class="container">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/#portfolio" class="no-smoothState">portifólio</a></li>
                <li><a href="/#cv" class="no-smoothState">cv</a></li>
            </ul>
